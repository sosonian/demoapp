...
export default function ResultRow(props) {
    return(
        <div className={"ResultRow"}>
            <div>
                <div className={"MovieMainTitle"}>{props.rowData ? <HightlightKeywordCell text={props.rowData.Movie_TitleMain ? props.rowData.Movie_TitleMain : props.rowData.Movie_TitleTranslation+" (翻譯片名)"} keywords={props.searchWord}/> :null}</div>
            </div>
            <div>
